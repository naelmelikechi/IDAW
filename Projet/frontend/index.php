            ...
            $.ajax({
                ...
                $('#users-table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'POIDS' },
                        { data: 'SEXE' },
                        { data: 'NIVEAU_ACTIVITE_SPORTIVE' },
                        {
                            data: null,
                            render: function (data, type, row) {
                                return '<button class="delete-user" data-id="' + data.ID_UTILISATEUR + '">Delete</button>&nbsp<button class="edit-user" data-id="' + data.ID_UTILISATEUR + '">Edit</button>';
                            }
                        }
                    ],
                    order: [[1, 'asc']]
